...
namespace ENT.Dto {
    ...
    /// </summary>
    public class DtoUserInfoRequest {
        #region Constants
        ...
        public DtoUserInfoRequest() {
            Username = "";
            Password = "";
            Email = "";
        }

        public DtoUserInfoRequest(string username, string password, string email) {
            Username = username;
            Password = password;
            Email = email;
        }

        public DtoUserInfoRequest(DtoUserInfoRequest userInfo) {
